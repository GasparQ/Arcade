...
{
  std::vector<t_highScore const *>::const_iterator	it = highScoreList.begin();
...
void					LoadHighScore::setHighScore(t_highScore const *newScore)
{
  highScoreList.push_back(newScore);
  std::sort(highScoreList.begin(), highScoreList.end(), LoadHighScore::isUpper);
}

const std::vector<t_highScore const *>	LoadHighScore::getAllHighScore() const
{
...
{
  std::ofstream						fd;
  std::vector<t_highScore const *>::const_iterator	it;
...
{
  std::vector<t_highScore const *>::const_iterator	it;
  const std::vector<t_highScore const *>		vectorHighScore =
